...
, buildPythonPackage
, cargo
# Used over implied "Security".  Not sure why they would make this a special
# snowflake.
, darwin
, datasets
, fetchFromGitHub
...
, rustPlatform
, rustc
# This requires passing via callPackage, which is pretty silly and makes other
# callPackage calls have to know about what Security is and provide it, when
# callPackage does that for us - we just have to drill to get it.
# , Security
, setuptools-rust
}:
